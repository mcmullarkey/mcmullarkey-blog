...
So, I created a bash script to download a couple hundred+[^3] .py files from Github that contain "sklearn" 
...
First, this tool absolutely did not *have* to be in Rust[^4], and wow was this implementation fast.
